...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <h2>Enter Coach Details</h2>
      <div class="form">
        <form class = 'add-coach' method="POST" enctype="multipart/form-data" action="">
        <p>
          Name  
        </p>
        <input type="text" name="name" class="text-input" placeholder="Enter Full Name Here">
        <br>
        <br>
        
        <p>Age</p>
        <input type="text" name="age" class="text-input" placeholder="Enter Age">
        <br>
        <br>
        <p>Email</p>
        ...
        <br>
        <br>
        <button class = "btn btn-sm btn-outline-secondary" name = 'addstudent'>Add</button>
...
<?php
        if(isset($_POST['addstudent'])){
            ...
            $sport= $_POST['sport'];
            $sql = "INSERT INTO coaches (name,age,email,gender,section_id,sport_id) 
            VALUES ('$name','$age','$email','$gender','$section','$sport')";
