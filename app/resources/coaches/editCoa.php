      ...
      <div class="table-responsive">
        ...
        <?php foreach ($coaches as $coach): ?>
            <tr>
              ...
              <td><a href="editcoaches.php?edit_id=<?php echo $coach['id'];?>" class = "edit">edit</a><td>
              <td><a onclick="return confirm('Are you sure you want to Delete this Record');"
              href="deleteCoa.php?delete_id=<?php echo $coach['id']; ?>" class="delete">delete</a><td>
