  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="form">
        ...
        <br>
        <p>Date of Birth</p>
        <input type="text" name="dob" class="text-input" placeholder="0000-00-00">
        <br>
        <br>
        <p>Gender</p>
...
<?php
        if(isset($_POST['addstudent'])){
            ...
            $sport= $_POST['sport'];
            $sql = "INSERT INTO students (name,age,dob,gender,section_id,sport_id) 
            VALUES ('$name','$age','$dob','$gender','$section','$sport')";
