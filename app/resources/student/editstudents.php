  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="form">
        ...
        <input type="text" name="name" class="text-input" placeholder="Enter Full Name Here" value = "<?php echo $student['name']?>">
        <br>
        <br>
        
        <p>Age</p>
        <input type="text" name="age" class="text-input" placeholder="Enter Age" value = "<?php echo $student['age']?>">
        <br>
        <br>
        <p>Date of Birth</p>
        <input type="text" name="dob" class="text-input" placeholder="0000-00-00" value="<?php echo $student['dob']?>">
        <br>
        <br>
        <p>Gender</p>
...
<?php
        if(isset($_POST['addstudent'])){
            ...
            $sport= $_POST['sport'];
            $sql = "UPDATE students SET name = '$name', age = '$age', dob = '$dob', gender = '$gender', section_id = '$section' , sport_id = '$sport'
            WHERE id = $id";
